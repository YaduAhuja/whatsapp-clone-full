		...
		<div className="landing-window">
			<div className="landing-main" >
				<div className="landing-main-content">
					<div className="landing-main-content-left">
						<div className="landing-title">
							To use Whatsapp-Clone on your computer:
						</div>
						<ol className="landing-main-content-ol">
							<li className="landing-main-content-li">Open Whatsapp on your phone</li>
							<li className="landing-main-content-li">Tap <strong> Menu </strong> <span className="svg-icon">
							...
							</span> or <strong> Settings </strong> <span className="svg-icon">
							...
							<li className="landing-main-content-li">Point your phone to this screen to capture the code</li>
						</ol>
					</div>
				</div>
